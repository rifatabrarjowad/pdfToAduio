...
IFontDisp = Font
__all__ = [ 'IFontEventsDisp', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_TRISTATE', 'OLE_YPOS_HIMETRIC', 'StdFont',
           'LoadPictureConstants', 'OLE_XSIZE_HIMETRIC', 'StdPicture',
           'OLE_YSIZE_HIMETRIC', 'Color', 'FONTITALIC',
           'OLE_CANCELBOOL', 'FONTSIZE', 'OLE_YPOS_CONTAINER',
           'IFont', 'VgaColor', 'OLE_XPOS_CONTAINER',
           'OLE_OPTEXCLUSIVE', 'OLE_YSIZE_PIXELS', 'Gray',
           'FONTUNDERSCORE', 'OLE_XPOS_PIXELS', 'Monochrome',
           'Default', 'Font', 'Picture', 'IPicture', 'FontEvents',
           'IFontDisp', 'OLE_XSIZE_PIXELS', 'OLE_YPOS_PIXELS',
           'OLE_YSIZE_CONTAINER', 'FONTNAME', 'Unchecked',
           'OLE_HANDLE', 'Checked', 'FONTBOLD', 'OLE_XSIZE_CONTAINER',
           'FONTSTRIKETHROUGH', 'OLE_COLOR', 'OLE_XPOS_HIMETRIC',
           'IPictureDisp']
